        ...
        {albums.map(x=>{
            return(<li key={x.id} className="albums__album">                
                    <div className="album__container">
                        ...
                        <a className="album__desc album_link" href={x.link} target='_blank' rel="noreferrer">Go to album</a>
                        <Link to={`/album/${x.id}`} className="album__desc album_link">More ...</Link>
                    </div>
                </li>)
        })}
        </ul>
